...
export default function TecnologiaDetailsCard({ tech }: TecnologiaDetailsCardProps) {
  return (
      ...
      <div className="flex flex-col md:flex-row items-center md:items-start gap-10">
        ...
        <div className="flex-1 text-center md:text-left">
          ...
          <div className="flex items-center gap-2 justify-center md:justify-start">
            <span className="text-gray-400 text-lg">Nível de domínio:</span>
            ...
            <span className="text-gray-500 ml-2">({tech.rating}/5)</span>
          </div>
        </div>
      </div>
    </div>
